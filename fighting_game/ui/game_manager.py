...
from .option_selector import OptionGenerator, OptionSelectorUI, AgentOption
from .multi_replay_player import MultiReplayPlayer
...
class GameManager:
    ...
    def run_training_phase(self) -> List[str]:
        ...
        self.agent1_save_path = f"models/agent1_phase{self.phase_number}_ep{self.total_episodes}.pth"
        self.agent2_save_path = f"models/agent2_phase{self.phase_number}_ep{self.total_episodes}.pth"
    ...
    def run_game(self):
        ...
        try:
            while True:
                ...
                print(f"Player 1 configured with {len(p1_config.features)} features")
                ...
                print(f"Player 2 configured with {len(p2_config.features)} features")
